...
<aside class="Profile_Nav">
    ...
    <a href="/HeyDaniel/Interface/Sheets/Profile" class="Profile_Nav_Link Btn_Nav_Row<?php echo $activeAccountNav === 'profile' ? ' Active' : '' ?>">
        <img src="<?php echo $path ?>Assets/Icons/user.svg" alt="" />
        <span>My Profile</span>
    </a>
    <a href="/HeyDaniel/Interface/Sheets/Orders" class="Profile_Nav_Link Btn_Nav_Row<?php echo $activeAccountNav === 'orders' ? ' Active' : '' ?>">
        <img src="<?php echo $path ?>Assets/Icons/history.svg" alt="" />
        <span>Orders</span>
    </a>
    <a href="/HeyDaniel/Interface/Sheets/Saved" class="Profile_Nav_Link Btn_Nav_Row<?php echo $activeAccountNav === 'wishlist' ? ' Active' : '' ?>">
    ...
    <a href="/HeyDaniel/Interface/Sheets/Cart" class="Profile_Nav_Link Btn_Nav_Row<?php echo $activeAccountNav === 'cart' ? ' Active' : '' ?>">
    ...
    <a href="/HeyDaniel/Interface/Sheets/Addresses" class="Profile_Nav_Link Btn_Nav_Row<?php echo $activeAccountNav === 'addresses' ? ' Active' : '' ?>">
        <img src="<?php echo $path ?>Assets/Icons/location.svg" alt="" />
        <span>Addresses</span>
    </a>
    <a href="/HeyDaniel/Interface/Sheets/PaymentMethods" class="Profile_Nav_Link Btn_Nav_Row<?php echo $activeAccountNav === 'payment' ? ' Active' : '' ?>">
        <img src="<?php echo $path ?>Assets/Icons/credit-card.svg" alt="" />
        <span>Payment Methods</span>
    </a>
    <a href="/HeyDaniel/Interface/Sheets/Notifications" class="Profile_Nav_Link Btn_Nav_Row<?php echo $activeAccountNav === 'notifications' ? ' Active' : '' ?>">
    ...
    <a href="/HeyDaniel/Interface/Sheets/Settings" class="Profile_Nav_Link Btn_Nav_Row<?php echo $activeAccountNav === 'settings' ? ' Active' : '' ?>">
        <img src="<?php echo $path ?>Assets/Icons/setting.svg" alt="" />
        <span>Settings</span>
    </a>
    <a href="/HeyDaniel/Interface/Sheets/HelpSupport" class="Profile_Nav_Link Btn_Nav_Row<?php echo $activeAccountNav === 'help' ? ' Active' : '' ?>">
