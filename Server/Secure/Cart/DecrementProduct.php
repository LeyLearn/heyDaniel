...
$response['table_source'] = $decrementProduct['table_source'] ?? null;
$response['subtotal'] = $decrementProduct['subtotal'] ?? 0.00;
$response['quantity'] = $decrementProduct['quantity'] ?? 0;
$response['total_count'] = $decrementProduct['total_count'] ?? 0;
